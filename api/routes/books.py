...
@router.get("/api/v1/books/{book_id}, response_model=Book, status_code=status")
async def get_book(book_id: int):
    ...
    return{"id": book.id, "title": book.title, "author": book.author, "published_year": book.published_year}
